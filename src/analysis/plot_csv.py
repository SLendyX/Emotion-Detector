...
# Plot Accuracy
axes[0].plot(df_history.index + 1, df_history['train_acc'], label='Training Accuracy')
axes[0].plot(df_history.index + 1, df_history['val_acc'], label='Validation Accuracy')
...
# Plot Loss
axes[1].plot(df_history.index + 1, df_history['train_loss'], label='Training Loss')
